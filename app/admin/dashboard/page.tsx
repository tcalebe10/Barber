  ...
  return (
    <div className="min-h-screen p-6 md:p-8 text-zinc-100 font-sans" style={{ backgroundColor: '#18181b' }}>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-8 mb-8 shadow-lg shadow-orange-500/10">
        <h1 className="text-3xl font-bold text-white mb-2">Bem-vindo ao Painel Administrativo</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="bg-[#1e1e24] p-5 rounded-xl border border-zinc-800/50 space-y-3">
            <Link href="/admin/schedule" className="block w-full bg-gradient-to-r from-orange-500 to-red-500 text-white text-center py-3 rounded-lg text-sm font-bold shadow-lg shadow-orange-500/20 hover:opacity-90 transition-all">
              + Novo Agendamento
            </Link>
            <Link href="/admin/clients" className="block w-full bg-zinc-800 text-zinc-300 hover:text-white hover:bg-zinc-700 text-center py-3 rounded-lg text-sm font-semibold transition-all">
              + Novo Cliente
            </Link>
            <Link href="/admin/services" className="block w-full bg-zinc-800 text-zinc-300 hover:text-white hover:bg-zinc-700 text-center py-3 rounded-lg text-sm font-semibold transition-all">
              Gerenciar Serviços
            </Link>
          </div>
        </div>
