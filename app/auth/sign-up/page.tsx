    ...
    <div className="relative min-h-screen w-full flex items-center justify-center p-6 md:p-10 bg-[#09090b] overflow-hidden">
      ...
      <div className="w-full max-w-sm z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-500 text-xs uppercase tracking-[0.2em] mt-1">Crie sua conta</p>
        </div>

        <SignUpForm />

        <div className="mt-12 text-center">
          <p className="text-zinc-700 text-[10px] uppercase tracking-[0.3em] font-bold">Bem-vindo</p>
        </div>
      </div>
    </div>
  );
